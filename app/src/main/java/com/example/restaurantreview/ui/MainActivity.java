...
public class MainActivity extends AppCompatActivity {
    ...
    private void findRestaurant() {
        showLoading(true);
        Call<ResponseRestaurant> client = ApiConfig.getApiService().getRestaurant(RESTAURANT_ID);
        client.enqueue(new Callback<ResponseRestaurant>() {
            @Override
            public void onResponse(@NotNull Call<ResponseRestaurant> call, @NotNull Response<ResponseRestaurant> response) {
                showLoading(false);
            ...
            @Override
            public void onFailure(@NotNull Call<ResponseRestaurant> call, @NotNull Throwable t) {
                showLoading(false);
